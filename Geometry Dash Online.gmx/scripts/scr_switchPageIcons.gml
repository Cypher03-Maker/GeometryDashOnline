...
switch(global.PageGameModes) {
    ...
    switch(global.PageSpiders) {
        ...
        with(Icon01) {
            spider_index = 0
            spider_extra_alpha = 1
            spider_extra_index = 0
        }
        
        with(Icon02) {
            spider_index = 1
            spider_extra_alpha = 1
            spider_extra_index = 1
        }
        
        with(Icon03) {
            spider_index = 2
            spider_extra_alpha = 1
            spider_extra_index = 2
        }
        
        with(Icon04) {
            spider_index = 3
            spider_extra_alpha = 1
            spider_extra_index = 3
        }
        
        with(Icon05) {
            spider_index = 4
            spider_extra_alpha = 1
            spider_extra_index = 4
        }
        break;
    }
    break;
    ...
    switch(global.PageSwings) {
        ...
        with(Icon13) {
            swing_index = 12
            swing_extra_alpha = 1
            swing_extra_index = 10
        }
        
        with(Icon14) {
            swing_index = 13
            swing_extra_alpha = 1
            swing_extra_index = 11
        }
        
        with(Icon15) {
            swing_index = 14
            swing_extra_alpha = 1
            swing_extra_index = 12
        }
        break;
    }
    break;
    ...
    switch(global.PageArmadillos) {
        ...
        with(Icon01) {
            armadillo_index = 0
            armadillo_extra_alpha = 1
            armadillo_extra_index = 0
        }
        break;
    }
    break;
