///view_position_update_spring2(vind,hamt,vamt,[obj]/[x,y]);
...
//Move view
view_hspd[_view] = lerp(view_hspd[_view],_a[0]-view_xview[_view],argument[1]);
view_vspd[_view] = lerp(view_vspd[_view],_a[1]-view_yview[_view],argument[2]);
