///view_angle_update_spring(vind,amt,[angle]);
...
//Find target angle
var _view = argument[0], _ang = view_angle[_view], _amt = argument[1], _a;
if argument_count > 2 {
 _ang = argument[2];
}
view_aspd[_view] = lerp(view_aspd[_view],angle_difference(_ang,view_angle[_view]),_amt);;
