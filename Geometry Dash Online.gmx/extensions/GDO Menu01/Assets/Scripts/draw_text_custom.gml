#define draw_text_custom
/// draw_text_custom(x,y,string,alpha,xscale,yscale)
...
while(string_length(_strab)>0)
{
       ...
       */
       ...
       draw_text_transformed_colour(_x+str_length,_y+str_height,str_part[i],_xscale,_yscale,0,d_color,d_color,d_color,d_color,_prealpha)
