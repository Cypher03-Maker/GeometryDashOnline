...
if (!instance_exists(obj_MenuPaletteColor)) {
    ...
    scr_create_gsButtonSimple(obj_gsButtonSimple, pos_x, pos_y, sprBtnPaletteColor, 11, 334, -310, c_white, c_white, noone, noone, noone, noone, scr_switchColorMode, 1, true);
    scr_create_gsButtonSimple(obj_gsButtonSimple, pos_x, pos_y, sprBtnPaletteColor, 11, 387, -310, c_white, c_white, noone, noone, noone, noone, scr_switchColorMode, 2, true);
    scr_create_gsButtonSimple(obj_gsButtonSimple, pos_x, pos_y, sprBtnPaletteColor, 11, 478, -310, c_white, c_white, noone, noone, noone, noone, scr_switchColorMode, 3, true);
